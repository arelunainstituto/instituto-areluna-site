...
const EsteticaFacialSection = () => {
  ...
  return (
    <section id="estetica" className="py-24 bg-gradient-to-br from-gray-100/40 via-gray-50/60 to-gray-100/40 dark:from-black dark:via-gray-900/60 dark:to-black relative overflow-hidden">
      ...
      <div className="absolute top-20 right-16 w-40 h-40 bg-gradient-to-br from-[hsl(var(--gold-leaf))]/15 to-[hsl(var(--ring))]/8 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-20 left-16 w-32 h-32 bg-gradient-to-br from-[hsl(var(--jet))]/12 to-[hsl(var(--gold-leaf))]/8 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
          ...
          <div className="order-2 lg:order-1 space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="w-32 h-px bg-gradient-to-r from-[hsl(var(--jet))] to-[hsl(var(--gold-leaf))] rounded-full"></div>
              </div>
            </div>
