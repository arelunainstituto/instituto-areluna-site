...
const TourismDentarioFAQSection = () => {
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-50/50 via-white to-gray-50/50 dark:from-gray-800/50 dark:via-gray-900 dark:to-gray-800/50 relative overflow-hidden">
      ...
      <div className="absolute top-20 right-16 w-40 h-40 bg-gradient-to-br from-[hsl(var(--jet))]/8 to-[hsl(var(--ring))]/4 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-20 left-16 w-32 h-32 bg-gradient-to-br from-[hsl(var(--ring))]/6 to-[hsl(var(--jet))]/4 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
