...
const WhatsAppFloat: React.FC<WhatsAppFloatProps> = ({ phoneNumber }) => {
  ...
  return (
    <div className="fixed right-4 sm:right-6 bottom-safe z-50">
      {/* Expanded Card */}
      {isExpanded && (
        <div className="absolute bottom-16 right-0 bg-white rounded-lg shadow-xl p-4 w-[calc(100vw-3rem)] sm:w-80 max-w-sm mb-2 border">
          <div className="flex justify-between items-start mb-3">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h3 className="font-semibold text-gray-800">Wellen Novato</h3>
                <p className="text-sm text-gray-600">Instituto Areluna</p>
              </div>
            </div>
            <button 
          ...
          <p className="text-gray-700 mb-4 text-sm">
            Olá! 👋 Sou a Wellen e estou aqui para ajudar com os seus implantes dentários. 
          </p>
          <button
